<template>
  ...
  >
    <div
      class="mx-auto flex flex-col items-center lg:grid max-w-7xl grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-16 lg:mx-0 lg:max-w-none lg:gap-y-10"
    >
      <div class="lg:sticky lg:top-4 lg:col-start-1 flex justify-center">
        <img
          class="w-full max-w-none rounded-lg bg-gray-900 shadow-xl ring-1 ring-gray-400/10"
      ...
      >
        <div class="text-center lg:text-left lg:flex-grow">
          <div class="px-4 lg:px-0">
            <div
              class="text-balance text-xl font-kaisei-decol tracking-tight text-neutral-800 md:text-2xl lg:text-4xl lg:leading-tight xl:text-4xl xl:leading-tight"
            >
              <h2>
    ...
    <div class="text-center container mx-auto py-16">
      ...
      <div class="grid gap-8 sm:grid-cols-2 sm:items-center">
        <div class="flex justify-center sm:order-1">
          <img
            ...
            alt="Image 3"
            class="w-full h-auto rounded-xl max-w-full lg:max-w-96 lg:h-auto"
          />
        </div>
        ...
        <div class="flex justify-center sm:order-2">
          <img
            ...
            alt="Image 4"
            class="w-full h-auto max-w-full rounded-xl lg:max-w-96 lg:h-auto"
          />
        </div>
      </div>

      <div class="text-center mt-8">
        <div class="text-xl font-kaisei-decol">Work</div>
      </div>
    </div>
  </div>
</template>
